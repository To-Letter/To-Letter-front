...
export default function SlideCard() {
  return (
    <main className="w-full h-full flex rounded-sm border-2 border-solid border-zinc-700 ">
      <Image
        width={540}
        height={600}
        ...
        alt="room-desk-chair"
      />
      <section className="w-[540px] h-[600px] bg-[#eedbcf] border-s-zinc-700 p-[24px]">
